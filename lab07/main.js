...
const stateBgClasses = ["bg-clear-weather", "bg-cloudy-weather", "bg-overcast-weather"];
...
function updateUI(currentState, currentTime) {
	...
	const bg = document.getElementById("bg-weather");
	box.textContent = stateNames[currentState];
	box.className = "weather-box " + stateClasses[currentState];
	bg.className = "bg-weather-box " + stateBgClasses[currentState];
